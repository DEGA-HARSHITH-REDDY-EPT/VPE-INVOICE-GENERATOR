...
- brand: product/brand name (e.g. "DEPROX 250", "Face Mask 3ply Elastic - Blue"). If the invoice has wrapped description lines under an item (e.g. "Sterile", "120x210 cm", material/GSM specs), append the relevant descriptive text to brand, not to pack — e.g. "Plain Sheet (Sterile)120x210 cm".
